...
export class AuthService {
    ...
    /**
     * Gets user info for all users that have the specified role
     * **Required role: STAFF**
     */
    public static getAuthUserByRole<ThrowOnError extends boolean = false>(options: Options<GetAuthUserByRoleData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).get<GetAuthUserByRoleResponse, unknown, ThrowOnError>({
