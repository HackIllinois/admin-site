...
export class SponsorService {
     ...
     */
    public static postSponsorResumebookFilterPagecount<ThrowOnError extends boolean = false>(options?: Options<PostSponsorResumebookFilterPagecountData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<PostSponsorResumebookFilterPagecountResponse, unknown, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
     ...
     * **Required role: SPONSOR**
     */
    public static postSponsorResumebookFilterByPage<ThrowOnError extends boolean = false>(options?: Options<PostSponsorResumebookFilterByPageData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<PostSponsorResumebookFilterByPageResponse, PostSponsorResumebookFilterByPageError, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
