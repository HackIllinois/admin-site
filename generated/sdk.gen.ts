...
export class JobService {
     ...
     * **Required role: ADMIN**
     */
    public static postJob<ThrowOnError extends boolean = false>(options?: Options<PostJobData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<PostJobResponse, unknown, ThrowOnError>({
            url: '/job/',
            ...options,
            headers: {
                'Content-Type': 'application/json',
     ...
     * **Required role: ADMIN**
     */
    public static deleteJobById<ThrowOnError extends boolean = false>(options: Options<DeleteJobByIdData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).delete<DeleteJobByIdResponse, DeleteJobByIdError, ThrowOnError>({
            url: '/job/{id}/',
            ...options
        });
    }
     ...
     * **Required role: ADMIN**
     */
    public static putJobById<ThrowOnError extends boolean = false>(options: Options<PutJobByIdData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).put<PutJobByIdResponse, PutJobByIdError, ThrowOnError>({
            url: '/job/{id}/',
            ...options,
            headers: {
                'Content-Type': 'application/json',
