...
export class AttendeeTeamService {
    ...
    /**
     * Assigns all attendees to random teams evenly
     * **Required role: STAFF**
     */
    public static postAttendeeTeamAssign<ThrowOnError extends boolean = false>(options?: Options<PostAttendeeTeamAssignData, ThrowOnError>) {
        return (options?.client ?? _heyApiClient).post<PostAttendeeTeamAssignResponse, unknown, ThrowOnError>({
