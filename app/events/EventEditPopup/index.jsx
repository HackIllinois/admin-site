        ...
        return (
            ...
            >
                ...
                <div className="popup-container">
                    <div className="title">
                        {this.isNewEvent() ? 'Add Event' : 'Edit Event'}
                    </div>
                    <Formik
                        initialValues={this.state.eventValues}
                            ...
                            <Form className="form">
                                ...
                                {this.props.staffEvent && (
                                    <SelectField
                                        ...
                                        name="eventType"
                                        menuPlacement="top"
                                        options={staffEventTypes.map(
                                            (staffEventType) => ({
                                                label: staffEventType,
                                                value: staffEventType,
                                            }),
                                        )}
                                        placeholder="Type"
                                    />
                                    ...
                                    <>
                                        <SelectField
                                            ...
                                            options={publicEventTypes.map(
                                                (publicEventType) => ({
                                                    label: publicEventType,
                                                    value: publicEventType,
                                                }),
                                            )}
                                            placeholder="Type"
                                        />
